...
import com.valcast.mapmates.data.utils.getList
import com.valcast.mapmates.data.utils.getRequiredString
import com.valcast.mapmates.data.utils.toEvent
import com.valcast.mapmates.domain.model.Event
import com.valcast.mapmates.domain.model.Result
import com.valcast.mapmates.domain.model.Result.Failure
import com.valcast.mapmates.domain.model.Result.Success
...
class FirebaseEventRepositoryImpl(
    ...
    override suspend fun getEvents(ids: List<String>?): com.valcast.mapmates.domain.model.Result<List<Event>> {
        return try {
    ...
    override suspend fun getEventsByAuthor(authorID: String): com.valcast.mapmates.domain.model.Result<List<Event>> {
        return try {
    ...
    override suspend fun getEventsByParticipant(participantID: String): com.valcast.mapmates.domain.model.Result<List<Event>> {
        return try {
            val events =
    ...
    override suspend fun getEvent(id: String): com.valcast.mapmates.domain.model.Result<Event> {
        return try {
    ...
    override suspend fun createEvent(event: Event): com.valcast.mapmates.domain.model.Result<String> {
        return try {
    ...
    @OptIn(ExperimentalTime::class)
    override suspend fun updateEvent(event: Event): com.valcast.mapmates.domain.model.Result<Unit> {
        return try {
    ...
    override suspend fun deleteEvent(id: String): com.valcast.mapmates.domain.model.Result<Unit> {
        return try {
    ...
    override suspend fun removeParticipant(
        eventID: String,
        userID: String
    ): com.valcast.mapmates.domain.model.Result<Unit> {
    ...
    override suspend fun sendJoinRequest(eventID: String): com.valcast.mapmates.domain.model.Result<Unit> {
    ...
    override suspend fun joinEvent(id: String): com.valcast.mapmates.domain.model.Result<Unit> {
        val currentUserId =
            firebaseAuth.currentUser?.uid ?: return Failure("User not authenticated")
        return try {
    ...
    override suspend fun leaveEvent(id: String): com.valcast.mapmates.domain.model.Result<Unit> {
        val currentUserId =
            firebaseAuth.currentUser?.uid ?: return Failure("User not authenticated")
        return try {
            val eventDocument = db.collection("events").document(id)
