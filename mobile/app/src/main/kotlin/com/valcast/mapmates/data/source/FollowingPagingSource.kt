...
import com.valcast.mapmates.data.utils.getLocalDateTime
import com.valcast.mapmates.data.utils.toUserPreview
import com.valcast.mapmates.domain.model.Relationship
...
class FollowingPagingSource(private val db: FirebaseFirestore, private val userId: String) :
    ...
    override suspend fun load(params: LoadParams<Long>): LoadResult<Long, Relationship> {
        return try {
            ...
            val query = db.collection("users").document(userId).collection("following")
