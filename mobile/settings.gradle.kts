...
include(":modules:feature-home:impl")
include(":modules:feature-event:api")
include(":modules:core-location:api")
include(":modules:core-location:impl")
include(":modules:feature-event:impl")
include(":modules:core-firebase")
include(":modules:feature-event:ui")
